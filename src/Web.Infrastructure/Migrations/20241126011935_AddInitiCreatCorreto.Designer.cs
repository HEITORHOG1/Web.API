...
namespace Web.Infrastructure.Migrations
{
    ...
    [Migration("20241126011935_AddInitiCreatCorreto")]
    partial class AddInitiCreatCorreto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web.Infrastructure.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Web.Infrastructure.Data.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Web.Domain.Entities.UsuarioEstabelecimento", b =>
                {
                    b.HasOne("Web.Domain.Entities.Estabelecimento", null)
                        .WithMany()
                        .HasForeignKey("EstabelecimentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Web.Infrastructure.Data.Models.RefreshToken", b =>
                {
                    b.HasOne("Web.Infrastructure.Data.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
