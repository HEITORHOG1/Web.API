...
{
    /// <inheritdoc />
    public partial class AddInitiCreatCorreto : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UltimoLoginIP = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TentativasLoginFalhas = table.Column<int>(type: "int", nullable: false),
                    BloqueioExpiraEm = table.Column<DateTime>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Entregadores_Estabelecimentos_EstabelecimentoId",
                        column: x => x.EstabelecimentoId,
                        principalTable: "Estabelecimentos",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Ativo = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    DataCreate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    EstabelecimentoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Fornecedores_Estabelecimentos_EstabelecimentoId",
                        column: x => x.EstabelecimentoId,
                        principalTable: "Estabelecimentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuariosEstabelecimentos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsuariosEstabelecimentos_AspNetUsers_UsuarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoDeBarras = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotasFiscais_Estabelecimentos_EstabelecimentoId",
                        column: x => x.EstabelecimentoId,
                        principalTable: "Estabelecimentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataHoraEntrega = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdicionaisProduto", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdicionaisProduto_Produtos_ProdutoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarrinhoItens_Estabelecimentos_EstabelecimentoId",
                        column: x => x.EstabelecimentoId,
                        principalTable: "Estabelecimentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovimentacoesEstoque_Estabelecimentos_EstabelecimentoId",
                        column: x => x.EstabelecimentoId,
                        principalTable: "Estabelecimentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OpcoesProduto_Produtos_ProdutoId",
                        column: x => x.ProdutoId,
                        principalTable: "Produtos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotasFiscaisProdutos_Produtos_ProdutoId",
                        column: x => x.ProdutoId,
                        principalTable: "Produtos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdicionalProdutoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItensPedidoAdicionais", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItensPedidoAdicionais_AdicionaisProduto_AdicionalProdutoId",
                        column: x => x.AdicionalProdutoId,
                        principalTable: "AdicionaisProduto",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    OpcaoProdutoId = table.Column<int>(type: "int", nullable: false),
                    Descricao = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                name: "ItensPedidoOpcoes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ItemPedidoId = table.Column<int>(type: "int", nullable: false),
                    ValorOpcaoProdutoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItensPedidoOpcoes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItensPedidoOpcoes_ItensPedido_ItemPedidoId",
                        column: x => x.ItemPedidoId,
                        principalTable: "ItensPedido",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItensPedidoOpcoes_ValoresOpcaoProduto_ValorOpcaoProdutoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdicionaisProduto_ProdutoId",
                table: "AdicionaisProduto",
                column: "ProdutoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarrinhoItem_Usuario_Estabelecimento_Search",
                table: "CarrinhoItens",
                columns: new[] { "UsuarioId", "EstabelecimentoId" });

            migrationBuilder.CreateIndex(
                name: "IX_CarrinhoItens_EstabelecimentoId",
                table: "CarrinhoItens",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Entregador_Documento_Unique",
                table: "Entregadores",
                column: "Documento",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Entregadores_EstabelecimentoId",
                table: "Entregadores",
                column: "EstabelecimentoId");

            migrationBuilder.CreateIndex(
                name: "IX_Entrega_Status_Search",
                table: "Entregas",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Estabelecimento_CNPJ_Unique",
                table: "Estabelecimentos",
                column: "CNPJ",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Estabelecimento_NomeFantasia_Search",
                table: "Estabelecimentos",
                column: "NomeFantasia");

            migrationBuilder.CreateIndex(
                name: "IX_Fornecedor_CNPJ_Unique",
                table: "Fornecedores",
                column: "CNPJ",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Fornecedor_Nome_Search",
                table: "Fornecedores",
                column: "Nome");

            migrationBuilder.CreateIndex(
                name: "IX_Fornecedores_EstabelecimentoId",
                table: "Fornecedores",
                column: "EstabelecimentoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItensPedidoAdicionais_AdicionalProdutoId",
                table: "ItensPedidoAdicionais",
                column: "AdicionalProdutoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItensPedidoOpcoes_ItemPedidoId",
                table: "ItensPedidoOpcoes",
                column: "ItemPedidoId");

            migrationBuilder.CreateIndex(
                name: "IX_ItensPedidoOpcoes_ValorOpcaoProdutoId",
                table: "ItensPedidoOpcoes",
                column: "ValorOpcaoProdutoId");

            migrationBuilder.CreateIndex(
                name: "IX_MovimentacaoEstoque_Data_Search",
                table: "MovimentacoesEstoque",
                column: "DataMovimentacao");

            migrationBuilder.CreateIndex(
                name: "IX_MovimentacoesEstoque_EstabelecimentoId",
                table: "MovimentacoesEstoque",
                column: "EstabelecimentoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotaFiscal_Numero_Unique",
                table: "NotasFiscais",
                column: "Numero",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_NotasFiscais_EstabelecimentoId",
                table: "NotasFiscais",
                column: "EstabelecimentoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotasFiscaisProdutos_ProdutoId",
                table: "NotasFiscaisProdutos",
                column: "ProdutoId");

            migrationBuilder.CreateIndex(
                name: "IX_OpcoesProduto_ProdutoId",
                table: "OpcoesProduto",
                column: "ProdutoId");

            migrationBuilder.CreateIndex(
                name: "IX_Pedido_Data_Search",
                table: "Pedidos",
                column: "DataCriacao");

            migrationBuilder.CreateIndex(
                name: "IX_Pedido_Status_Data_Search",
                table: "Pedidos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Produto_Disponivel_Status",
                table: "Produtos",
                column: "Disponivel");

            migrationBuilder.CreateIndex(
                name: "IX_Produto_Nome_Search",
                table: "Produtos",
                column: "Nome");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsuariosEstabelecimentos_UsuarioId",
                table: "UsuariosEstabelecimentos",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_ValoresOpcaoProduto_OpcaoProdutoId",
